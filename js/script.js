...
const arrowRight = document.querySelector('.sucursales-box .navigation .arrow-right')
const arrowLeft = document.querySelector('.sucursales-box .navigation .arrow-left')
...
document.getElementById("contact-form").addEventListener("submit", function (event) {
    ...
    // Enviar el correo
    emailjs
        .send("service_zmdfkb6", "template_pi3omeh", templateParams)
        .then(
            function (response) {
